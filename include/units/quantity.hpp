...
namespace units
{
    ...
    namespace detail
    {
        ...
        class quantity_base
        {
            using Quantity = quantity<T, Unit, ApplyMagnitudePolicy>;
    ...
    class quantity : public detail::quantity_base<Unit, T, ApplyMagnitudePolicy>
    {
        ...
        friend class detail::quantity_maker;
    ...
    namespace detail
    {
        ...
        constexpr T quantity_base<Unit, T, ApplyMagnitudePolicy>::in(Unit2) const
        {
            ...
            return ApplyMagnitudePolicy::template apply<MagnitudeToApply>(value_);
        }
...
template<typename Unit, typename T, typename = std::enable_if_t<
    units::detail::is_unit<Unit> && !units::detail::is_unit<T>>>
